...
public class LargestGapInArray {
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(LargestGapInArray.class);
		for(Failure fail : result.getFailures())
			System.out.println(fail.toString());
		
		System.out.println("Was LargestGapArray successful : "+result.wasSuccessful());
		
	}

	public int largestGap(int[] a) {
		Arrays.sort(a);
		int high = 0;
